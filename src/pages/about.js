...
return (
  ...
  <section>
    <div className="mx-auto max-w-screen-xl px-4 py-12 sm:px-6 md:pb-16 md:pt-10 lg:px-8">
      <div className="mx-auto max-w-3xl text-center">
        <h2 className="text-3xl font-bold text-gray-900 sm:text-4xl">
           Approuvé par les plus grandes entreprises d'e-commerce
        </h2>
          ...
          <blockquote className="rounded-lg bg-gray-100 p-8">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="mt-1 text-lg font-medium text-gray-700">Vicky Népamort</p>
              </div>
            </div>
          ...
          <blockquote className="rounded-lg bg-gray-100 p-8">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="mt-1 text-lg font-medium text-gray-700">Tom Égérie</p>
              </div>
            </div>
          ...
          <blockquote className="rounded-lg bg-gray-100 p-8">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="mt-1 text-lg font-medium text-gray-700">Carla Parolédor</p>
              </div>
            </div>
          ...
          <blockquote className="rounded-lg bg-gray-100 p-8">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="mt-1 text-lg font-medium text-gray-700">Emma Paradé</p>
              </div>
            </div>
          ...
          <blockquote className="rounded-lg bg-gray-100 p-8">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="mt-1 text-lg font-medium text-gray-700">Alain Toks</p>
              </div>
            </div>
